...
//-----------------------------------------------------------------------
uint32_t CagmVectorFieldOps::Initialize(int *_N, int *_NphysL, int *_NphysH, double *_step)
{
	N[0] = _N[0];
	N[1] = _N[1];
	N[2] = _N[2];
...
//-----------------------------------------------------------------------
uint32_t CagmVectorFieldOps::SetSteps(double *_step)
{
    step[0] = _step[0];
    step[1] = _step[1];
    step[2] = _step[2];
...
//
////-----------------------------------------------------------------------
//uint32_t CagmVectorFieldOps::planeDerivative2(int layer, double *d, double *dd)
//{
//    int kx, ky;
//    for (ky = 0; ky < N[1]; ky++)
//        for (kx = 0; kx < N[0]; kx++)
